...
public class WorkingWithForms
{
	...
	public static void main(String[] args)
	{
		...
		driver.get("file:///D:/workingwithforms.html");
		
                driver.navigate.refresh();
                driver.windowes.Maximize();
		//Find Username textbox and enter value
		driver.findElement(By.id("txtUserName")).sendKeys("Priti");

		//Find Password textbox and enter value
		driver.findElement(By.name("txtPwd")).sendKeys("priti@123");
		...
		driver.findElement(By.cssSelector("input.Format1")).sendKeys("priti");
		
		//Find Last Name textbox and enter value
		driver.findElement(By.name("txtLN")).sendKeys("Trupti");
		
		//Find Gender radio button and enter value
		driver.findElement(By.cssSelector("input[value='Female']")).click();
		
		//Find Date Of Birth textbox and enter value
		driver.findElement(By.name("DtOB")).sendKeys("30/06/20001");
		
		//Find Email textbox and enter value
		driver.findElement(By.name("Email")).sendKeys("priti.walture@igate.com");
		
		//Find Address textbox and enter value
		driver.findElement(By.name("Address")).sendKeys("Kopargaon");
		...
		driver.findElement(By.xpath("//html/body/form/table/tbody/tr[11]/td[2]/input")).sendKeys("8696847964");
